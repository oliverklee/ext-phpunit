	...
	public function addError(PHPUnit_Framework_Test $test, Exception $e, $time) {
		...
		$this->output(
			'<script type="text/javascript">/*<![CDATA[*/setProgressBarClass("hadError");/*]]>*/</script>' .
				...
				'<strong><span class="hadError">!</span> Error</strong> in test case <em>' . htmlspecialchars($test->getName()) .
				'</em><br />File: <em>' . $fileName . '</em>' .
	...
	public function addFailure(PHPUnit_Framework_Test $test, PHPUnit_Framework_AssertionFailedError $e, $time) {
		...
		$this->output(
			'<script type="text/javascript">/*<![CDATA[*/setProgressBarClass("hadFailure");/*]]>*/</script>' .
				...
				'<strong><span class="hadFailure">!</span> Failure</strong> in test case <em>' . htmlspecialchars($test->getName()) . '</em>' .
